...
const ItemConfig = ( navigation ) =>([
    ...
    { key: 'cancel',       title: 'Cancel',          icon: <AntDesign name='close'        color='red'       size={24} />, onPress: ()=> navigation.navigate('Coverages'), style:{ container:{ backgroundColor:'red'}, title: {color:'white'}}},
])
